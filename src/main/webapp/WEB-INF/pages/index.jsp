    ...
    <div class="layui-header title">
        <div class="layui-container">
            ...
            <c:if test="${not empty loginUser }">
	            <div class="personalCenter layui-pull-right"><a href="toUserSystem" style="color:#fff"><i class="layui-icon layui-icon-tree"></i>个人中心</a></div>
            </c:if>
            <c:if test="${empty loginUser }">
                <div class="personalCenter layui-pull-right"><a href="toAdminLogin" style="color:#fff"><i class="layui-icon layui-icon-tree"></i>管理员</a></div>
            </c:if>
            <c:if test="${empty loginUser }">
